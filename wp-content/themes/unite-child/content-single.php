...
<?php
		...
		<div class="custom_fields">
			<p><spa><?php echo _e('Ticket Price') ?></spa>:&nbsp;&nbsp;&nbsp;&nbsp;<span class="price">$<?php echo get_field('ticket_price') ?></span></p>
			<p><spa><?php echo _e('Release Date') ?></spa>:&nbsp;&nbsp;&nbsp;&nbsp;<span class="release_date"><?php echo get_field('release_date') ?></span></p>
			<p><spa><?php echo _e('Genres') ?></spa>:&nbsp;&nbsp;&nbsp;&nbsp;<span class="genres"><?php echo implode(', ',wp_get_post_terms(get_the_ID(),'film-genres', array("fields" => "names"))); ?></span></p>
			<p><spa><?php echo _e('Country') ?></spa>:&nbsp;&nbsp;&nbsp;&nbsp;<span class="country"><?php echo implode(',',wp_get_post_terms(get_the_ID(),'film-country', array("fields" => "names"))); ?></span></p>
		</div>
